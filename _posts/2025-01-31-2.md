...
![Structure of the models.](./images/model.png)
...
![Parallel efficiency of SCF.](./images/SCF-eff-1.png)
...
![Parallel efficiency of ORCA SCF.](./images/ORCA-SCF-eff.png)
...
![Parallel efficiency of gradient.](./images/Gradient-eff.png)
| Model\Cores | 1 | 2 | 4 | 8 | 16 |
| - | - | - | - | - | - |
...
![Parallel efficiency of ORCA gradient.](./images/ORCA-SCF-eff.png)

### Hessian (Ongoing)
![Parallel efficiency of Hessian.](./images/Hessian-eff.png)
...
## Conclusion
The parallel efficiency of DFT in PySCF is lower than that of ORCA, so using fewer cores is recommended. The 
the fake intel tricked MKL version of PySCF is slightly faster than OpenBlas one.
